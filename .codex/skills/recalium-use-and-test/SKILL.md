...
This skill applies to Codex-style agents working in this repository. If the agent does not automatically load skill files, follow this file manually when `AGENTS.md` references it.
