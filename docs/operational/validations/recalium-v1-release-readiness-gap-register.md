...
| RR-002 | Frontend nav | ✓ CLOSED — Nav enablement + RR-011 keyboard/E2E evidence audited (2026-08-26) | All v1 sections enabled; LeftNav Vitest + Playwright route smoke + Tab navigation evidenced. | ✓ Evidence: [2026-08-26-rr002-rr005-ui-evidence-audit.md](2026-08-26-rr002-rr005-ui-evidence-audit.md), `frontend/src/tests/LeftNav.test.tsx`, `frontend/e2e/keyboard-navigation.spec.ts`, `frontend/e2e/keyboard-workflows.spec.ts` |
...
| RR-005 | Review queue UI/API | ✓ CLOSED — Grouped comparison + resolve/dismiss + keyboard/E2E evidence audited (2026-08-26) | Duplicate/overlap cleanup release-evidenced at UI, API, and keyboard layers. | ✓ Evidence: [2026-08-26-rr002-rr005-ui-evidence-audit.md](2026-08-26-rr002-rr005-ui-evidence-audit.md), `frontend/src/tests/ReviewQueuePage.test.tsx`, `backend/tests/api/test_review_queue_api.py`, `frontend/e2e/keyboard-workflows.spec.ts` |
...
| RR-010 | MCP resources/evidence | ✓ M1 CLOSED — Live-client evidence complete (2026-08-26); MCP *resources* deferred to M3 | Live SSE client proof for schemas, invalid inputs, audit actors, concurrent sessions. Resource implementation is M3. | ✓ Evidence: [2026-08-26-rr010-mcp-live-client-evidence.md](2026-08-26-rr010-mcp-live-client-evidence.md), `backend/tests/e2e/test_mcp_live_client.py` |
...
| RR-014 | Release evidence | ✓ CLOSED — Acceptance-criteria evidence matrix published (2026-07-24) | All 47 acceptance criteria (29 product-level, 4 NFR, 5 anti-criteria, 4 BYOK, 5 scope-guard) mapped to verified test/code evidence: 40 evidenced, 4 partial, 3 gaps (none release-blocking — see matrix's recommendation section). | ✓ Evidence: [recalium-v1-acceptance-criteria-evidence-matrix.md](recalium-v1-acceptance-criteria-evidence-matrix.md) |
