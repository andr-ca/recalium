...
| RR-010 MCP resources & live coverage | **PO decision 2026-08-26:** MCP *resources* deferred to M3; M1 delivers live-client *evidence* only (schemas, invalid inputs, audit metadata, concurrent SSE). Recorded in gap register RR-010 row. |
